...
create table sys_dept (
  dept_id           serial       not null  ,  --  comment '部门id',
  parent_id         integer      default 0     ,         --    comment '父部门id',
  ...
  create_time 	    datetime  year to second   ,             --  comment '创建时间',
  update_by         varchar(64)     default '' ,              --  comment '更新者',
  update_time       datetime  year to second                ,                  --  comment '更新时间',
  primary key (dept_id)  constraint pk_sys_dept
);
...
create table sys_user (
  ...
  login_date        datetime  year to second  ,               -- comment '最后登录时间',
  pwd_update_date   datetime  year to second ,                                  --comment '密码最后更新时间',
  create_by         varchar(64)     default '' ,              --  comment '创建者',
  create_time       datetime  year to second ,                                 -- comment '创建时间',
  update_by         varchar(64)     default '',               --  comment '更新者',
  update_time       datetime  year to second ,                  --  comment '更新时间',
  remark            lvarchar(500)    default null,              -- comment '备注',
  primary key (user_id) constraint pk_sys_user
)
...
(
  post_id       serial      not null,    -- comment '岗位ID',
  ...
  update_time   datetime year to second ,                           --       comment '更新时间',
  remark        lvarchar(500)    default null,        --       comment '备注',
  primary key (post_id) constraint pk_sys_post
)
...
create table sys_role (
  role_id           serial      not null,    --comment '角色ID',
  ...
  update_time       datetime year to second,                                   --comment '更新时间',
  remark            lvarchar(500)    default null,               --comment '备注',
  primary key (role_id) constraint pk_sys_role
) ;
...
create table sys_menu (
  ...
  parent_id         integer      default 0 ,                 --comment '父菜单ID',
  order_num         integer          default 0 ,                 --comment '显示顺序',
  ...
  update_by         varchar(64)     default '',                 --comment '更新者',
  update_time       datetime year to second,                                   --comment '更新时间',
  remark            lvarchar(500)    default '' ,                --comment '备注',
  primary key (menu_id) constraint pk_sys_menu
)
...
create table sys_user_role (
  ...
  primary key(user_id, role_id) constraint pk_sys_user_role
)
...
create table sys_role_menu (
  role_id   integer not null, --comment '角色ID',
  menu_id   integer not null, --comment '菜单ID',
  primary key(role_id, menu_id) constraint pk_sys_role_menu
)
...
create table sys_role_dept (
  ...
  primary key(role_id, dept_id)  constraint pk_sys_role_dept
);
...
(
  user_id   integer not null, --comment '用户ID',
  post_id   integer not null, --comment '岗位ID',
  primary key (user_id, post_id)  constraint pk_sys_user_post
);
...
create table sys_oper_log (
  oper_id           serial      not null ,    --comment '日志主键',
  ...
  oper_url          lvarchar(255)    default '' ,                --comment '请求URL',
  oper_ip           varchar(128)    default '',                 --comment '主机地址',
  oper_location     lvarchar(255)    default '',                 --comment '操作地点',
  oper_param        lvarchar(2000)   default '' ,                --comment '请求参数',
  json_result       lvarchar(2000)   default '' ,                --comment '返回参数',
  status            integer          default 0 ,                 --comment '操作状态（0正常 1异常）',
  error_msg         lvarchar(2000)   default '' ,                --comment '错误消息',
  oper_time         datetime  year to second ,                                  --comment '操作时间',
  cost_time         integer      default 0 ,                 --comment '消耗时间',
  primary key (oper_id) constraint pk_sys_oper_log
);

create index idx_sys_oper_log_bt on
sys_oper_log (business_type asc) ;
create index idx_sys_oper_log_s on
sys_oper_log (status asc) ;
create index idx_sys_oper_log_ot on
sys_oper_log (oper_time asc) ;
...
(
  dict_id          serial      not null,    --comment '字典主键',
  ...
  update_time      datetime year to second,                                   --comment '更新时间',
  remark           lvarchar(500)    default null ,              --comment '备注',
  primary key (dict_id) constraint pk_sys_dict_type,
  unique (dict_type) constraint un_dict_type
);
...
(
  dict_code        integer      not null,    --comment '字典编码',
  ...
  update_time      datetime year to second,                                  --comment '更新时间',
  remark           lvarchar(500)    default null,               --comment '备注',
  primary key (dict_code) constraint pk_sys_dict_data
);
...
create table sys_config (
  config_id         serial          not null ,    --comment '参数主键',
  config_name       varchar(100)    default '',                 --comment '参数名称',
  config_key        varchar(100)    default '' ,               -- comment '参数键名',
  config_value      lvarchar(500)    default '' ,               -- comment '参数键值',
  ...
  update_time       datetime year to SECOND,                                 -- comment '更新时间',
  remark            lvarchar(500)    default null ,            --  comment '备注',
  primary key (config_id) constraint pk_sys_config
)
...
create table sys_logininfor (
  info_id        serial     not null,   --comment '访问ID',
  login_name     varchar(50)    default '',                --comment '登录账号',
  ipaddr         varchar(128)   default '',                --comment '登录IP地址',
  login_location lvarchar(255)   default '' ,              -- comment '登录地点',
  browser        varchar(50)    default '',               -- comment '浏览器类型',
  os             varchar(50)    default '',                --comment '操作系统',
  status         char(1)        default '0',               --comment '登录状态（0成功 1失败）',
  msg            lvarchar(255)   default '',                --comment '提示消息',
  login_time     datetime year to second ,                                --comment '访问时间',
  primary key (info_id) constraint pk_sys_logininfor

)
create index idx_sys_logininfor_s on
sys_logininfor (status asc) ;
create index idx_sys_logininfor_lt on
sys_logininfor (login_time asc) ;
...
create table sys_user_online (
  ...
  start_timestamp   datetime year to second ,                               --comment 'session创建时间',
  last_access_time  datetime year to second ,                             --  comment 'session最后访问时间',
  expire_time       integer        default 0   ,              --comment '超时时间，单位为分钟',
  primary key (sessionId) constraint pk_sys_user_online
)
...
create table sys_job (
  job_id              serial    not null ,    --comment '任务ID',
  job_name            varchar(64)   default '',                 --comment '任务名称',
  job_group           varchar(64)   default 'DEFAULT',          --comment '任务组名',
  invoke_target       lvarchar(500)  not null  ,                 --comment '调用目标字符串',
  cron_expression     lvarchar(255)  default ''  ,               --comment 'cron执行表达式',
  ...
  update_by           varchar(64)   default ''                -- comment '更新者',
  update_time         datetime year to SECOND ,                            --   comment '更新时间',
  remark              lvarchar(500)  default ''               --  comment '备注信息',
  primary key (job_id, job_name, job_group) constraint pk_sys_job
)
...
create table sys_job_log (
  job_log_id          serial     not null,    --comment '任务日志ID',
  job_name            varchar(64)    not null,                   --comment '任务名称',
  job_group           varchar(64)    not null,                   --comment '任务组名',
  invoke_target       lvarchar(500)   not null,                   --comment '调用目标字符串',
  job_message         lvarchar(500),                              --comment '日志信息',
  status              char(1)        default '0',                --comment '执行状态（0正常 1失败）',
  exception_info      lvarchar(2000)  default '',                 --comment '异常信息',
  create_time         datetime year to second ,                                 --comment '创建时间',
  primary key (job_log_id) constraint pk_sys_job_log
)
...
create table sys_notice (
  notice_id         serial         not null ,    --comment '公告ID',
  notice_title      varchar(50)     not null ,                  --comment '公告标题',
  notice_type       char(1)         not null ,                  --comment '公告类型（1通知 2公告）',
  notice_content    lvarchar(2000)   default null,               --comment '公告内容',
  status            char(1)         default '0' ,               --comment '公告状态（0正常 1关闭）',
  create_by         varchar(64)     default '',                 --comment '创建者',
  create_time       datetime   year to SECOND  ,                   --comment '创建时间',
  update_by         varchar(64)     default '',                 --comment '更新者',
  update_time       datetime   year to second ,                          --comment '更新时间',
  remark            lvarchar(255)    default null ,              --comment '备注',
  primary key (notice_id) constraint pk_sys_notice
)
...
create table gen_table (
  table_id             integer      not null ,    --comment '编号',
  table_name           lvarchar(200)    default '',                -- comment '表名称',
  table_comment        lvarchar(500)    default '',                -- comment '表描述',
  sub_table_name       varchar(64)     default null,              -- comment '关联子表的表名',
  sub_table_fk_name    varchar(64)     default null,             --  comment '子表关联的外键名',
  class_name           varchar(100)    default '' ,               -- comment '实体类名称',
  tpl_category         lvarchar(200)    default 'crud' ,          --  comment '使用的模板（crud单表操作 tree树表操作 sub主子表操作）',
  ...
  gen_path             lvarchar(200)    default '/',              --  comment '生成路径（不填默认项目路径）',
  options              lvarchar(1000)  ,                           -- comment '其它生成选项',
  create_by            varchar(64)     default '' ,             --   comment '创建者',
  create_time 	       datetime year to SECOND ,                                  --comment '创建时间',
  update_by            varchar(64)     default '' ,              --  comment '更新者',
  update_time          datetime    year to second ,                            --  comment '更新时间',
  remark               lvarchar(500)    default null,               --comment '备注',
  primary key (table_id) constraint pk_gen_table
);
...
create table gen_table_column (
  column_id         serial      not null ,   -- comment '编号',
  table_id          integer  ,                             --  comment '归属表编号',
  column_name       lvarchar(200) ,                            --  comment '列名称',
  column_comment    lvarchar(500),                             --  comment '列描述',
  column_type       varchar(100) ,                            --  comment '列类型',
  java_type         lvarchar(500) ,                            --  comment 'JAVA类型',
  java_field        lvarchar(200),                           --    comment 'JAVA字段名',
  ...
  query_type        lvarchar(200)    default 'EQ',          --     comment '查询方式（等于、不等于、大于、小于、范围）',
  html_type         lvarchar(200),                           --    comment '显示类型（文本框、文本域、下拉框、复选框、单选框、日期控件）',
  dict_type         lvarchar(200)    default '',             --    comment '字典类型',
  sort              integer   ,                                   --  comment '排序',
  create_by         varchar(64)     default '',             --    comment '创建者',
  create_time 	    datetime year to second ,                                 -- comment '创建时间',
  update_by         varchar(64)     default '' ,               -- comment '更新者',
  update_time       datetime year to second,                                  -- comment '更新时间',
  primary key (column_id) constraint pk_gen_table_column
)